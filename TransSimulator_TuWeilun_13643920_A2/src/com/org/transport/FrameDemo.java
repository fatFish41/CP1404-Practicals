...
public class FrameDemo extends JFrame {
    ...
    class MyPanel extends JPanel {
        ...
        public void drawLine(Graphics g) {
            ...
            g.drawLine(275, 250, 275, 465);
            g.drawLine(350, 465, 750, 465);
            g.drawLine(50, 465, 275, 465);
            g.drawLine(50, 550, 275, 550);
            g.drawLine(350, 550, 850, 550);

            g.drawLine(275, 550, 275, 600);
            g.drawLine(350, 550, 350, 600);

            g.drawLine(350, 100, 350, 175);
            g.drawLine(350, 250, 350, 465);
            g.drawLine(1250, 100, 1250, 175);
//            g.drawLine(350, 175, 1250, 175);
            g.drawLine(350, 175, 750, 175);
            g.drawLine(850, 175, 1250, 175);
            g.drawLine(750, 175, 750, 100);
            g.drawLine(850, 175, 850, 100);
...
//            g.drawLine(350, 175, 1250, 175);
        ...
        public void drawLight(Graphics g, Light t) {
            ...
            if (t.getl5() == 0) {
                g.setColor(Color.red);
                g.fillOval(275, 455, 8, 8);// l9
                g.fillOval(342, 548, 8, 8);// l10
                g.setColor(Color.green);
                g.fillOval(265, 542, 8, 8);// l11
                g.fillOval(350, 465, 8, 8);// l12
            ...
            if (t.getl5() == 0) {
                g.setColor(Color.red);
                g.fillOval(810, 210, 8, 8);// l13
                g.fillOval(790, 210, 8, 8);// l14
                g.setColor(Color.green);
                g.fillOval(800, 220, 8, 8);// l15
                g.fillOval(800, 200, 8, 8);// l16
            ...
            if (t.getl5() == 0) {
                g.setColor(Color.red);
                g.fillOval(790, 505, 8, 8);// l
                g.setColor(Color.green);
                g.fillOval(800, 497, 8, 8);// l
        ...
        public void drawblocks(Graphics g) {
            ...
            g.fillRect(50, 210, 215, 5);
            g.fillRect(360, 210, 385, 5);
            g.fillRect(860, 210, 385, 5);
            g.fillRect(50, 505, 215, 5);
            g.fillRect(360, 505, 385, 5);
            g.fillRect(1335, 210, 215, 5);

            g.fillRect(800, 260, 5, 195);
            g.fillRect(800, 100, 5, 65);

            g.fillRect(312, 100, 3, 65);
            g.fillRect(312, 260, 3, 195);
            g.fillRect(1287, 100, 3, 65);
            g.fillRect(1287, 260, 3, 295);
